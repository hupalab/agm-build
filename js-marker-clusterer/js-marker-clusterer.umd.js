(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('js-marker-clusterer'), require('rxjs/Observable'), require('markerwithlabel'), require('@agm/core')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'js-marker-clusterer', 'rxjs/Observable', 'markerwithlabel', '@agm/core'], factory) :
	(factory((global.ngmaps = global.ngmaps || {}, global.ngmaps.jsMarkerClusterer = global.ngmaps.jsMarkerClusterer || {}),global.ng.core,null,global.Rx,global.MarkerWithLabel,global.ngmaps.core));
}(this, (function (exports,_angular_core,jsMarkerClusterer,rxjs_Observable,MarkerWithLabel,_agm_core) { 'use strict';
...
var GoogleMapsAPIWrapper = (function () {
    ...
    GoogleMapsAPIWrapper.prototype.createMap = function (el, mapOptions) {
        ...
        return this._loader.load().then(function () {
            ...
            _this.markerFactory = new MarkerWithLabel(google.maps);
            return;
        });
    };
    ...
    GoogleMapsAPIWrapper.prototype.createMarker = function (options, addToMap) {
        ...
        return this._map.then(function (map) {
            ...
            return new _this.markerFactory(options);
        });
    };
...
var MarkerManager$1 = (function () {
    ...
    MarkerManager$$1.prototype.updateAnimation = function (marker) {
    ...
    MarkerManager$$1.prototype.updateInfoLabel = function (marker) {
        return this._markers.get(marker).then(function (m) {
...
MarkerManager$1.decorators = [
    { type: _angular_core.Injectable },
];
/** @nocollapse */
MarkerManager$1.ctorParameters = function () { return [
...
AgmMarkerCluster.decorators = [
    { type: _angular_core.Directive, args: [{
                ...
                providers: [
                    ClusterManager,
                    { provide: _agm_core.MarkerManager, useExisting: ClusterManager },
                    _agm_core.InfoWindowManager,
                ]
            },] },
];
/** @nocollapse */
